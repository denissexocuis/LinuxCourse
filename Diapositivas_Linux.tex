...
\renewcommand{\sfdefault}{phv}  %Fuente Helvetica

%%% aquí va esa cosa del formato para la portada y así :) 
\title{Curso de Introducción a Linux}
\author{Martínez Schleske Alan \\ Lara Xocuis Martha Denisse \\ Madrigal Lagunes Orlando \\ Themsel Montes Guillermo Francisco \\ Lopez Castillo Haziel \\ Ortiz Chavez Gonzalo}

%% aqui inicia el documento
\begin{document}

%% Diapo de la primera portada :)
\begin{titleframe}{}
    \maketitle
\end{titleframe}
...
\begin{titleframe}{}
    \begin{center}
        \includegraphics[width=1\linewidth]{images/linux1.jpg}     
    \end{center}
\end{titleframe}


\section{Long Text}
\begin{frame}{Filosofía del software libre}
    texto
\end{frame}

%% lista y asi 
\section{List}
\begin{frame}{Listado de cosas etc...}
